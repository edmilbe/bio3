...
<section class="cont-terceiro check-item">
    <div class="itens-check">
        <div class="forms">
            <span class="title-form">Recuper Account</span>
            ...
            <form class="new-cad" method="post" action="<?=PROOT?>register/recoverpass/<?=$this->key?>"  enctype="multipart/form-data">
                ...
                <fieldset><legend>Count</legend>
                    <div class="gpc">
                        <label class="c-titlo">New Password:</label>
                        <input type="password" id="password" name="password" class="c-item-name form-text" >

                    </div>
                    <div class="gpc">
                        <label class="c-titlo">Confirm New Password:</label>
                ...
                <div class="gpc">
                    <input type="submit" name="save" class="butoes-one" value="Confirm" min="0">
