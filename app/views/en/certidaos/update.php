...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>auto/update" method="post" class="form">
        ...
        <div class="form__group">
            ...
            <input type="text" autocomplete="off" class="form__input" name="atestado_bi_number" id="form__input-0"
                   onkeyup="getAuto();" required>
        </div>

        <div class="form__group">
            <label class="form__label" for="form__input-1">Nº da Autorização <span class="form__label__about">(campo necessário)</span></label>
        ...
        <div class="form__group form__group--3">
            <input type="submit" name="submit" id="submit" value="Atualizar Autorização &rarr;" class="btn btn-submit">
        </div>
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <a href="<?=PROOT?>auto/create" class="list-others__item--link">&rarr; Nova Autorização</a>
            </li>
            <li class="list-others__item">
                <a href="<?= PROOT ?>auto/buscar" class="list-others__item--link">&rarr; Buscar Autorizações</a>
            </li>
            <li class="list-others__item">
