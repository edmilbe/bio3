...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>bi/buscar" method="post" class="form">
        ...
        <div class="form__group form__group--1">
            <label class="form__label" for="form__input-1">Nº de Autorização <span class="form__label__about">(campo necessário)</span></label>
            <input type="text" autocomplete="off" class="form__input" name="atestado_bi_number" id="form__input-0"

                   placeholder="Escreva numero do bi ou nome"
                   onkeyup="buscaAuto();" required>
        </div>
