...
<section class="form-section" id="form-section">
    ...
    foreach ($this->atestado as $atestado):
        ?>
        <a href="<?=PROOT?>auto/closed/<?=$this->pageno?>/<?=$atestado->atestado_id?>/#popup" class="document">
    ...
    <ul class="pagination">
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/closed">Ínicio</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/closed<?=($this->pageno <= 1) ? "": $this->pageno-1?>">&leftarrow; Anterior</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/closed<?=($this->pageno >= $this->total_pages) ? "": $this->pageno + 1?>">Seguinte &rightarrow;</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/closed<?=$this->total_pages?>">Final</a>
        </li>
    </ul>
