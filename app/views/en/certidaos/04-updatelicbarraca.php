...
<section class="form-section" id="form-section">
    <h1 class="section-title">
        Atualização de Licença para Funcionamento
    </h1>
    ...
    <form action="<?= PROOT ?>auto/updatelicbarraca/<?=$this->atestado;?>/<?= $this->bi;?>/<?=$this->type?>" method="post" class="form">
        ...
        <div class="form__group form__group--2">
            <label class="form__label" for="objecto">Empreendimento <span class="form__label__about">(campo obrigatório)</span></label>
            <input type="text" onkeyup="newemprego(<?php echo $this->bi;?>);" value="<?=$this->post['house']?>" autocomplete="off" class="form__input" name="objecto" id="objecto" required>
        </div>
        ...
        <div class="form__group form__group--2">
            <label class="form__label" for="tempo">Validade <span class="form__label__about">(campo obrigatório)</span></label>
