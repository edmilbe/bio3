...
<section class="form-section" id="form-section">
    <h1 class="section-title">
        Atulização de atestado para fins de Percepção da Pensão de Sobrevivência
    </h1>
    ...
    <form action="<?= PROOT ?>atestado/updatepersonmorte/<?=$this->atestado;?>/<?= $this->bi;?>" method="post" class="form">
