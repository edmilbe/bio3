...
<section class="form-section" id="form-section">
    <ul class="list-others">
        ...
        <li class="list-others__item">
            <a href="<?= PROOT ?>dir/aprovadosc" class="list-others__item--link">&rarr; Aprovados</a>
        </li>
        <li class="list-others__item">
    ...
    foreach ($this->atestado as $atestado):
        ?>
        <a  href="<?=PROOT?>dir/aprovados1/<?=$this->pageno?>/<?=$atestado->atestado_id?>/#popup" class="document">
    ...
    <ul class="pagination">
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/aprovados/">Ínicio</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/aprovados/<?=($this->pageno <= 1) ? "": $this->pageno-1?>">&leftarrow; Anterior</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/aprovados/<?=($this->pageno >= $this->total_pages) ? "": $this->pageno + 1?>">Seguinte &rightarrow;</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/aprovados/<?=$this->total_pages?>">Final</a>
        </li>
    </ul>
...
<textarea name="obs"
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <button onclick="auto_concluir(<?=$this->atestado_view->atestado_id;?>);" class="btn btn__okay"> Concluir</button>
            </li>
            <li class="list-others__item">
