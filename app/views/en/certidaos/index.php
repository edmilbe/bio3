...
<section class="form-section" id="form-section">
    <ul class="list-others">
        <li class="list-others__item">
            <a href="<?= PROOT ?>auto/index" class="list-others__item--link">&rarr; Devolvidas</a>
        </li>
        <li class="list-others__item">
            <a href="<?= PROOT ?>auto/pendentes" class="list-others__item--link">&rarr; Pendentes</a>
        </li>
        <li class="list-others__item">
            <a href="<?= PROOT ?>dir/aprovados1" class="list-others__item--link">&rarr; Aprovadas</a>
        </li>
        <li class="list-others__item">
            <a href="<?= PROOT ?>auto/closed" class="list-others__item--link">&rarr; Concluídas</a>
        </li>

    </ul>

    <h1 class="section-title">
        Autorizações Devolvidas
    </h1>
    ...
    foreach ($this->atestado as $atestado):
        ?>
        <a  href="<?=PROOT?>auto/index/<?=$this->pageno?>/<?=$atestado->atestado_id?>/#popup" class="document">
    ...
    <ul class="pagination">
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/index/">Ínicio</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/index/<?=($this->pageno <= 1) ? "": $this->pageno-1?>">&leftarrow; Anterior</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/index/<?=($this->pageno >= $this->total_pages) ? "": $this->pageno + 1?>">Seguinte &rightarrow;</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>auto/index/<?=$this->total_pages?>">Final</a>
        </li>
    </ul>
...
<textarea name="obs"
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <button onclick="auto_pendente(<?=$this->atestado_view->atestado_id;?>);" class="btn btn__okay"> Enviar para aprovação</button>
            </li>

            <li class="list-others__item">
                <button onclick="auto1_imprimir(<?=$this->atestado_view->atestado_id;?>);" class="btn btn__imprimir"> Imprimir</button>
            </li>
