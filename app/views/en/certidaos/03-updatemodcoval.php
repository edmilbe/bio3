...
<section class="form-section" id="form-section">
    <h1 class="section-title">
        Atualização de Autorização para Modificar Coval</h1>
    ...
    <form action="<?= PROOT ?>auto/updatemodcoval/<?=$this->atestado;?>/<?= $this->bi;?>/<?=$this->type?>" method="post" class="form">
        ...
        <div class="form__group">
            <label class="form__label" for="ano">Ano de Aquisição </label>
        ...
        <div class="form__group">
            <label class="form__label" for="modific">Modificações </label>

            <select onchange="newemprego(<?php echo $this->bi;?>);" class="form__input" id="modific" name="modific">
                <?php

                foreach ($this->modifics as $modific):

                    ?>
                    <option value="<?=$modific->modific_id?>"

                        <?php echo  $this->post['modific'] ==  $modific->modific_id ? "selected": "";   ?>

                        ><?=utf8_encode($modific->modific_name)?></option>
