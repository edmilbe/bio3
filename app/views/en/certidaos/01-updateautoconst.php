...
<section class="form-section" id="form-section">
    <h1 class="section-title">
        Atulização de Autorização para Construção/Modificação de Barracas de Alvenária
    </h1>
    ...
    <form action="<?= PROOT ?>auto/updateautoconst/<?=$this->atestado;?>/<?= $this->bi;?>/<?=$this->type?>" method="post" class="form">
