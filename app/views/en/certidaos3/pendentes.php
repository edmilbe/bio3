...
<section class="form-section" id="form-section">
    ...
    foreach ($this->atestado as $atestado):
        ?>
        <a href="<?=PROOT?>atestado/pendentes/<?=$this->pageno?>/<?=$atestado->atestado_id?>#popup" class="document">
    ...
    <ul class="pagination">
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/pendentes/">Ínicio</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/pendentes/<?=($this->pageno <= 1) ? "": $this->pageno-1?>">&leftarrow; Anterior</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/pendentes/<?=($this->pageno >= $this->total_pages) ? "": $this->pageno + 1?>">Seguinte &rightarrow;</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/pendentes/<?=$this->total_pages?>">Final</a>
        </li>
    </ul>
...
<div class="popup" id="popup">
    ...
    <div class="popup__content">
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <button onclick="atestado_aprovar(<?=$this->atestado_view->atestado_id;?>);" class="btn btn__okay"> Aprovar</button>
            </li>
            <li class="list-others__item">
