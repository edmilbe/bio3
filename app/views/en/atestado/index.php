...
<section class="form-section" id="form-section">
    ...
    foreach ($this->atestado as $atestado):
        ?>
        <a  href="<?=PROOT?>atestado/index/<?=$this->pageno?>/<?=$atestado->atestado_id?>#popup" class="document">
...
<textarea name="obs"
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <button onclick="atestado_pendente(<?=$this->atestado_view->atestado_id;?>);" class="btn btn__okay"> Enviar para aprovação</button>
            </li>
            ...
            <li class="list-others__item">
                ...
                //$link = "http://camaramezochi.st/files/atestados/" . $this->atestado_view->atestado_id . ".pdf";
                //http://camaramezochi.st/atestado/pendentes/1/10374/#popup
                ?>
