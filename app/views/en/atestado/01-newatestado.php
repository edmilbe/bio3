...
<section class="form-section" id="form-section">
    ...
    <form action="#" class="form">
        ...
        <div class="form__group form__group--1">
            <label class="form__label" for="form__input-1">Nº do Documento de Identificação <span class="form__label__about">(campo necessário)</span></label>
        ...
        <div class="form__group">
            ...
            <input value="<?=$this->bis->bi_estado?>"  type="text" class="form__input" id="form2__input-2" name="estado" readonly>
        </div>
        <div class="form__group">
    ...
    <form action="<?= PROOT ?>atestado/newatestado1/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
