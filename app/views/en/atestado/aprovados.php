...
<section class="form-section" id="form-section">
    ...
    foreach ($this->atestado as $atestado):
        ?>
        <a  href="<?=PROOT?>dir/aprovados/<?=$this->pageno?>/<?=$atestado->atestado_id?>#popup" class="document">
    ...
    <ul class="pagination">
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/aprovados/">Ínicio</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/aprovados/<?=($this->pageno <= 1) ? "": $this->pageno-1?>">&leftarrow; Anterior</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/aprovados/<?=($this->pageno >= $this->total_pages) ? "": $this->pageno + 1?>">Seguinte &rightarrow;</a>
        </li>
        <li class="pagination__li">
            <a class="pagination__a" href="<?=PROOT?>atestado/aprovados/<?=$this->total_pages?>">Final</a>
        </li>
    </ul>
...
<textarea name="obs"
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <button onclick="atestado_concluir(<?=$this->atestado_view->atestado_id;?>);" class="btn btn__okay"> Concluir</button>
            </li>
            <li class="list-others__item">
