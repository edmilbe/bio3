...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>atestado/newatestado2/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
        ...
        <div class="form__group">
            <label class="form__label" for="entidade">Entidade </label>

            <select onchange="newemprego(<?php echo $this->bi;?>);" class="form__input" id="entidade" name="entidade">
                <?php
        ...
        <div class="form__group">
            <label class="form__label" for="univer">Universidade </label>

            <select onchange="newemprego(<?php echo $this->bi;?>);" class="form__input" id="univer" name="univer">
                <?php

                foreach ($this->univers as $univer):

                    ?>
                    <option value="<?=$univer->univer_id?>"

                        <?php echo  $this->post['univer'] ==  $univer->univer_id ? "selected": "";   ?>

                        ><?=$univer->univer_name?></option>
