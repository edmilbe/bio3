...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>atestado/updateatestado4/<?=$this->atestado;?>/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
        ...
        <div class="form__group">
            <label class="form__label" for="localidade2">Localidade </label>

            <select onchange="newemprego(<?php echo $this->bi;?>);" class="form__input" id="localidade2" name="localidade2">
                <?php
                ...
                foreach ($this->localidades as $localidade):
                    ...
                    <option value="<?=$localidade->localidade_id?>"
                        ...
                        <?php echo  $this->post['localidade2'] ==  $localidade->localidade_id ? "selected": "";   ?>
