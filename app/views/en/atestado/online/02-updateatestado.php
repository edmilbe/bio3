...
<section class="form-section" id="form-section">
    <h1 class="section-title">
        Atualizar atestado para Fins de <?=$this->name;?>
    </h1>
    ...
    <form action="<?= PROOT ?>atestado/updateatestado2/<?=$this->atestado;?>/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
            ...
            <select onchange="newemprego(<?php echo $this->bi;?>);" class="form__input" id="univer" name="univer">
                ...
                foreach ($this->univers as $univer):
                    ...
                    <option value="<?=$univer->univer_id?>"
                        ...
                        ><?=utf8_encode($univer->univer_name)?></option>
