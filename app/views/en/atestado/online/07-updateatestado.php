...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>atestado/updateatestado7/<?=$this->atestado;?>/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
        ...
        <div class="form__group form__group--2">
            <label class="form__label" for="nome-1">Nome do/da companheiro(a) <span class="form__label__about">(campo obrigatório)</span></label>
        ...
        <div class="form__group">
            <label class="form__label" for="localidade-1">Localidade 1</label>
