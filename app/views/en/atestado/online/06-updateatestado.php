...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>atestado/updateatestado6/<?=$this->atestado;?>/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
        ...
        <div class="form__group form__group--2">
            <label class="form__label" for="servico">Entidade Empregadora<span class="form__label__about">(campo obrigatório)</span></label>
            <input type="text" onkeyup="newemprego(<?php echo $this->bi;?>);" value="<?=$this->post['servico']?>" autocomplete="off" class="form__input" name="servico" id="servico" required>
        </div>
