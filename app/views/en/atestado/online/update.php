...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>atestado/update" method="post" class="form">
        ...
        <div class="form__group">
            ...
            <input type="text" autocomplete="off" class="form__input" name="atestado_bi_number" id="form__input-0"
                   onkeyup="getAtestado();" required>
        </div>

        <div class="form__group">
            <label class="form__label" for="form__input-1">Nº de Atestado <span class="form__label__about">(campo necessário)</span></label>
            <input type="text" autocomplete="off" class="form__input" name="atestado_number" id="form__input-1"
                   onkeyup="getAtestado();" required>
        </div>
        ...
        <div class="form__group">
            <label class="form__label" for="form__input-5">Atestado <span class="form__label__about">(campo obrigatório)</span></label>

            <select class="form__input" id="form2__input-5" name="atestado_type">
                <option value="1">Fins de Emprego</option>
                <option value="2">Bolsa de Estudos </option>
                ...
                <option value="16">Agregado Familiar</option>
        ...
        <div class="form__group form__group--3">
            <input type="submit" name="submit" id="submit" value="Atualizar atestado &rarr;" class="btn btn-submit">
        </div>
        ...
        <ul class="list-others">
            <li class="list-others__item">
                <a href="<?=PROOT?>atestado/create" class="list-others__item--link">&rarr; Novo Atestado</a>
            </li>
            <li class="list-others__item">
                <a href="<?= PROOT ?>atestado/" class="list-others__item--link">&rarr; Buscar Atestados</a>
            </li>
            <li class="list-others__item">
                <a href="<?= PROOT ?>bi/newbi" class="list-others__item--link">&rarr; Novo Bilhetes de Identidade</a>
