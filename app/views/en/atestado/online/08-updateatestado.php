...
<section class="form-section" id="form-section">
    ...
    <form action="<?= PROOT ?>atestado/updateatestado8/<?=$this->atestado;?>/<?=$this->bi;?>/<?=$this->type;?>" method="post" class="form">
        ...
        <div class="form__group form__group--2">
            <label class="form__label" for="nome-2">Nome do/da companheiro(a) <span class="form__label__about">(campo obrigatório)</span></label>
