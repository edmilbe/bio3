            ...
            <aside class="aside left">
                ...
                <ul class="aside-list">
                    ...
                    foreach ($this->others as $prd):
                        ?>
                        <li><a href="<?= PROOT ?>home/index/<?=  $this->on; ?>/<?= $prd->group2_id; ?>"
                               class="<?php
                               echo $this->selected == $prd->group2_id ? "selected" : "";

                               ?>"

                                ><?= $prd->group2_name; ?></a></li>
                        <?php
                    endforeach;
                    ?>
                </ul>
                ...
                <div class="items-all">
                    ...
                    foreach ($this->items as $prd):
                        ...
                        <div class="item-one">
                            ...
                            <div class="item-img"><a href="<?= PROOT ?>home/view/<?=  $this->on; ?>/<?=  $this->onon; ?>/<?= $prd->prd_id; ?>">
                                    <img src="<?= PROOT ?>files/prds/<?=$prd->file_name;?>" alt="<?=$prd->prd_name;?>">
                                </a>
                            </div>
                            ...
                            <div class="item-name">
                            <span><a
                                    href="<?= PROOT ?>home/index/<?=$this->on;?>/<?=  $this->onon; ?>/<?=$prd->prd_id;?>"><?= utf8_decode($prd->prd_name); ?></a></span>
                            </div>
                            <div class="item-options">
                                ...
                                <span><button onclick="addfromindex(<?=$prd->prd_id?>);">Add
                                    </button></span>
                            </div>
