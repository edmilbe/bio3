                ...
                <div class="items-all">
                    ...
                    foreach ($this->items as $prd):
                        ...
                        <div class="item-one">
                            ...
                            <div class="item-img"><a href="<?= PROOT ?>home/view/<?= $prd->prd_id; ?>">
                                    <img src="<?= PROOT ?>files/prds/1531350850.png">
                                </a>
                            </div>
                            ...
                            <div class="item-name">
                            <span><a
                                    href="<?= PROOT ?>home/view/<?= $prd->prd_id; ?>"><?= utf8_decode($prd->prd_name); ?></a></span>
                            </div>
                            <div class="item-options">
                                ...
                                <span><button onclick="s_from_plus(<?= $prd->prd_id ?>, <?= $prd->prd_escala ?>)">Add
                                    </button></span>
                            </div>
