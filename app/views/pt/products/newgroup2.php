    ...
    <div class="itens-check itens-edit">
        ...
        <div class="item-check item-edit">
            <div class="pegado">
                ...
                <form class="check-pr" method="post" onsubmit="return valforgr2();" enctype="multipart/form-data" >
                    <div class="gpc">
                        ...
                        <select class="select-edit c-item-name" name="grupo" id="grupo">
                            ...
                            if($this->grupos != false){
                                foreach($this->grupos as $gr){
                                    ?>
                                    <option value="<?=$gr->group1_id;?>" <?php echo $this->post['grupo'] == $gr->group1_id ? "selected" : ""  ?>><?=$gr->group1_name;?></option>
                                    <?php
                                }
                            }
                            ?>
