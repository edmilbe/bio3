                ...
                if ($_POST) {
                    ...
                    if ($validation->passed()) {
                        ...
                        if ($id > 0) {
                            ...
                            $this->view->displayErrors = $validation->displayOkay("Autorização criado com o número $id. <a target='_blank' href='$link'>Clique aqui para aceder a Autorização</a>");
                ...
                if ($_POST) {
                    ...
                    if ($validation->passed()) {
                        ...
                        if ($id > 0) {
                            ...
                            $this->view->displayErrors = $validation->displayOkay("Certificado criado com o número $id. <a target='_blank' href='$link'>Clique aqui para aceder ao Certificado</a>");
                ...
                if ($_POST) {
                    ...
                    if ($validation->passed()) {
                        ...
                        if ($id > 0) {
                            ...
                            $this->view->displayErrors = $validation->displayOkay("Licença criada com o número $id. <a target='_blank' href='$link'>Clique aqui para a Licença</a>");
                ...
                if ($_POST) {
                    ...
                    if ($validation->passed()) {
                        ...
                        if ($atestado > 0) {
                            ...
                            $this->view->displayErrors = $validation->displayOkay("Autorização atualizada com o número $atestado. <a target='_blank' href='$link'>Clique aqui para aceder ao atestado</a>");
                        }
...
<body>
    ...
    <p class='p-left'>
     ...
     <p class='p-left'>
     Certifico que deu-se por comprado o coval número $numero_coval do ano $ano_coval, do Cemitério $cemiterio_coval, onde se encontram os restos mortais de $nome_coval, falecido(a) em $data1_coval e Sepultado em $data2_coval, $ao $trata
...
Por esta Câmara se faz Constar as autoridades e mais pessoas a quem o conhecimento desta competir que foi concedida Autorização à $trata $bi->bi_name, $estado, natural de $bi_nasc_loc, distrito de $bi_nasc_dist, $bi_nasc_pais, $nascido em $bi_nasc_dia de $bi_nasc_mes de $bi_nasc_ano, $filho de  $bi_pai e de $bi_mae, portador do $documento número  $bi_number, passado pelo $bi_emi_entidade, em $bi_emi_dia de $bi_emi_mes de $bi_emi_ano, reside efetivamente $atestado_casa, na localidade de $atestado_localidade, distrito de $atestado_distrito, deste Estado.
