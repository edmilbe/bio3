...
class Turismo extends  Controller {
    ...
    public function indexAction(){
            ...
            if (Token::check(Input::get('token'))) {
                if ($_POST) {
                    ...
                    $validation->check($_POST, [
                        ...
                        'titulo' => [
                            'display' => 'Insira o nome da Associação',
                            'require' => true
                        ],
                        'text' => [
                            'display' => 'Insira o texto sobre a Associação',
                            'require' => true
                        ]
                    ]);
                    ...
                    if ($validation->passed()) {
                        ...
                        if (!isset($_FILES['photo']['name'])) {
                            ...
                            //dnd($_FILES['photo']);
                            $img = $Files->SaveAFile($_FILES['photo'], 'turismos');
                            //dnd($img);
                            $id_news = $Posts->newPost($_POST, $img);

                            if($id_news > 0){
                                $link = PROOT . "home/turismoread/" . $id_news;
        ...
        $this->view->render('turismo/turismonew');
